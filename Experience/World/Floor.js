...
export default class Floor {
  ...
  setCircles() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: 0x315399 });
    const material2 = new THREE.MeshStandardMaterial({ color: 0x315399 });
    const material3 = new THREE.MeshStandardMaterial({ color: 0x315399 });
